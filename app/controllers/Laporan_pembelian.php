...
class Laporan_pembelian extends User_Controller {

	public function __construct() {
		parent::__construct();
		$this->load->model('Laporan_pembelian_model','model');
	}
	...
	public function index() {
		...
		$data['get_faktur_pembelian'] = $this->model->get_faktur_pembelian();
		$data['title'] = lang('purchase_report');
		$data['subtitle'] = lang('list');
		$data['content'] = 'Laporan_pembelian/index';
	...
	public function printpdf() {
	    ...
	    $data = array_merge($data,path_info());
	    $html = $this->load->view('Laporan_pembelian/printpdf', $data, TRUE);
	    $pdf->loadHtml($html);
	...
	public function export_excel() {
		...
		$get_faktur_pembelian = $this->model->get_faktur_pembelian();
