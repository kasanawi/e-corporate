                        ...
                        <tbody> 
                            ...
                            <?php foreach ($pemesanandetail as $row): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right" width="12%">
                                        <input type="text" name="diskon[]" class="form-control diskon text-right" value="<?php echo number_format($row['diskon']) ?>" maxlength="2" >
                                    </td>
                                    <td class="text-right" width="12%">
                                        <input type="text" name="ppn[]" class="form-control ppn text-right" value="<?php echo number_format($row['ppn']) ?>" maxlength="2">
                                    </td>
                                    <td class="text-right" width="12%">
...
<script type="text/javascript">
    ...
    $('#table_detail tbody').on('change','.harga, .jumlah, .diskon, .ppn',function(){
        ...
        if(jumlah > data.jumlahsisa) {
            NotifyError('Kesalah input jumlah!');
