    ...
    <div class="page-header-content header-elements-md-inline">
        ...
        <div class="header-elements d-none">
            <div class="d-flex justify-content-center">
                <div class="btn-group">
                    <a href="{site_url}pembayaran_penjualan/printpdf/{id}" target="_blank" class="btn btn-primary">
                        <?php echo lang('print') ?>
                    </a>
        ...
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-md-6 text-left">
                    ...
                    <div class="btn-group">
                        <?php if ($status !== '3'): ?>
                            <a href="{site_url}pembayaran_penjualan/create?idfaktur={idpembayaran}" class="btn btn-outline-primary">
