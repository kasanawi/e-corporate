        ...
        <div class="card-body">
            ...
            <form action="javascript:save()" id="form1">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label><?php echo lang('Total_Kredit_Memo') ?>:</label>
                            <input type="text" class="form-control decimalnumber totalkreditmemo" name="totalkreditmemo" disabled value="{totalkreditmemo}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label><?php echo lang('Sisa_Tagihan') ?>:</label>
                            <input type="text" class="form-control decimalnumber sisatagihan" name="sisatagihan" disabled value="{sisatagihan}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label><?php echo lang('Pembayaran_Kredit_Memo') ?>:</label>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('.totaldibayar').change(function(){
            ...
            var totalkreditmemo = numeral( $('.totalkreditmemo').val() ).value();
            var sisatagihan = numeral( $('.sisatagihan').val() ).value();
            if(val > totalkreditmemo || val > sisatagihan) {
                NotifyError('Debet pembayaran tidak boleh lebih besar dari kredit memo!');
