                    ...
                    <?php if ($get_faktur_penjualan): ?>
                        ...
                        <?php foreach ($get_faktur_penjualan as $row): ?>
                            ...
                            <tr>
                                ...
                                <td class="text-right font-weight-bold"><?php echo number_format($totaldetailpenjualan) ?></td>
                            </tr>
                        <?php endforeach ?>
                    <?php else: ?>
                        <tr>
            ...
            <?php if ($get_faktur_penjualan): ?>
                <tfoot>
                    <tr class="bg-light">
                        ...
                        <td class="text-right font-weight-bold"><?php echo number_format($grandtotalpenjualan) ?></td>
                    </tr>
                </tfoot>
            <?php endif ?>
        </table>
