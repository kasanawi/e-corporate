                    ...
                    <div class="row">
                      <div class="col-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="masaManfaat" id="masaManfaat" value="{masaManfaat}">
                        </div>
                      </div>
                      <div class="col-6">
                        <div class="form-group">
                          <label>Batas Kapitalisasi</label>
                          <input type="text" class="form-control" name="batasKapitalisasi" id="batasKapitalisasi" value="{batasKapitalisasi}">
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row">
                      <div class="col-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="tambahanMasaManfaat" id="tambahanMasaManfaat" value="{tambahanMasaManfaat}">
                        </div>
                      </div>
                      <div class="col-6">
                        <div class="form-group">
                          <label>Prosentasi Penyusutan</label>
                          <input type="text" class="form-control" name="prosentasiPenyusutan" id="prosentasiPenyusutan" value="{prosentasiPenyusutan}">
                        </div>
                      </div>
                    </div>
                  </div>
...
<script>
  $(document).ready(function () {
    ...
    var newOption = new Option('{namaBarang}', '{barang}', true, true);
  ...
  function simpan(elemen) {
    ...
    $.ajax({
      url         : '{site_url}Inventaris/simpanKonfigurasiPenyusutan/<?= $this->uri->segment(3); ?>',
      data        : data,
      method      : 'post',
      dataType    : 'json',
      processData : false,
