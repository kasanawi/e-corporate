...
class Account_accountnumbers_model extends CI_Model {
	...
	public function save() {
		...
		if($id) {
			...
			foreach($this->input->post() as $key => $val) $this->db->set($key,strip_tags($val));
			$this->db->set('notopakun',substr($this->input->post('noheader'), 0,1));
	...
	public function get_new_noakun() {
		$noheader = $this->uri->segment(3);
		$sql = $this->db->query("CALL pgetnewnoakun('".$noheader."')")->row();
		$data['new_noakun'] = $sql->new_akun;
